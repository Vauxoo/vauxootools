...
Vauxoo Tools could always use more documentation, whether as part of the 
official Vauxoo Tools docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, and 3.3, and for PyPy. Check 
   https://travis-ci.org/nhomar/vauxootools/pull_requests
...
To run a subset of tests::
	...
	$ python -m unittest tests.test_vauxootools